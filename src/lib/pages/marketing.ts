    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: '¿Cuánto hay que invertir en marketing digital en Panamá?', a: 'Dos cifras distintas y conviene no mezclarlas: el fee de gestión, que nos pagas a nosotros, y la inversión publicitaria, que va directo a Google o a Meta con tu tarjeta. Nosotros no marcamos la pauta ni cobramos comisión sobre ella. Para que la campaña tenga datos suficientes hay que sostenerla varias semanas seguidas; encender y apagar cada quince días no deja aprender al sistema. El fee no incluye ITBMS (7%).' },
          { q: '¿Cuándo NO conviene invertir en pauta todavía?', a: 'Cuando la página a la que va a llegar la gente no convierte: pagar clics para mandarlos a un sitio lento o confuso es comprar visitas caras que rebotan. Tampoco cuando nadie va a contestar los mensajes que genere. Primero se arregla el destino y quién atiende; después se abre la llave.' },
          { q: '¿Qué gastos fijos tiene la parte digital además de la pauta?', a: 'Los que sostienen el destino al que mandas el tráfico: infraestructura desde $350 al año y mantenimiento desde $59 al mes. Parece secundario hasta que pagas clics para llevarlos a un sitio caído o lento. La pauta va aparte y directo a la plataforma, y nuestro fee no incluye ITBMS (7%).' },
        ],
      },
      {
        type: 'steps',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { slug: 'servicios/landing-pages-alta-conversion-panama', label: 'Landing Pages' },
          { slug: 'crecimiento/seo-posicionamiento-web-panama', label: 'SEO y Posicionamiento' },
          { slug: 'blog/cuanto-invertir-en-publicidad-digital-en-panama', label: 'Cuánto invertir en pauta' },
        ],
      },
    ],
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: '¿Cuánto se necesita para arrancar con Meta Ads en Panamá?', a: 'Hay que separar dos cosas: el fee de gestión, que es nuestro, y la inversión en anuncios, que va directo a Meta desde tu tarjeta. Nosotros no cobramos comisión sobre esa inversión. El sistema necesita varias semanas seguidas de datos para optimizar; presupuestos que se prenden y apagan no aprenden. El fee no incluye ITBMS (7%).' },
          { q: '¿Cuándo NO conviene Meta Ads?', a: 'Cuando vendes algo que la gente busca activamente y con urgencia (una grúa, un cerrajero, un plomero de emergencia): ahí conviene Google, porque el cliente ya está buscando. Meta funciona para generar demanda, no para capturarla en el momento exacto.' },
        ],
      },
      {
        type: 'steps',
      ...
      },
      {
        ...
        items: [
          ...
          { slug: 'blog/embudo-de-ventas-para-negocios-panama', label: 'Embudo de ventas' },
          { slug: 'blog/google-ads-vs-facebook-ads-en-panama', label: 'Google Ads o Meta Ads' },
        ],
      },
    ],
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: '¿Qué mueve el precio del contenido: los canales o el video?', a: 'Se cobra un fee mensual según la cantidad de piezas y de canales; producir video cuesta más que producir gráfica, y ese es el factor que más mueve el número. La pauta para amplificar, si la hay, se paga aparte y va directo a la plataforma. El fee no incluye ITBMS (7%).' },
        ],
      },
      {
        type: 'steps',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: '¿Qué se paga aparte del email marketing?', a: 'El fee de gestión cubre estrategia, diseño de las piezas y los envíos. Aparte va la plataforma de correo, que se paga por número de contactos y crece con tu lista. La cuenta que decide si conviene: una lista propia no te cobra por cada persona que alcanzas, a diferencia de la pauta. Ese es todo el argumento. El fee no incluye ITBMS (7%).' },
          { q: '¿Cuándo NO conviene arrancar con email marketing?', a: 'Cuando no tienes lista propia y la idea es comprarla. Una lista comprada quema el dominio, se va a spam y no vuelve. Tampoco si no tienes nada que contar todavía: mandar por mandar entrena a tu cliente a ignorarte.' },
        ],
      },
      {
        type: 'steps',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: '¿Cuándo NO conviene el WhatsApp masivo?', a: 'Cuando la lista no dio permiso. Escribirle a números conseguidos por ahí no es marketing, es la vía rápida a que te reporten y te bloqueen el número. Tampoco conviene si nadie va a responder: una campaña masiva devuelve conversaciones, y una conversación sin respuesta hace más daño que el mensaje que nunca mandaste.' },
        ],
      },
      {
        type: 'steps',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: '¿En qué se mide el retorno de una automatización?', a: 'La automatización se cotiza por flujo, según cuántos sistemas hay que conectar y qué tan enredado está el proceso hoy. La cuenta que importa no es el precio sino las horas: si alguien pasa datos a mano media hora al día, son unas diez horas al mes que se recuperan y no vuelven a perderse. Los precios no incluyen ITBMS (7%).' },
          { q: '¿Cuándo NO conviene automatizar un proceso?', a: 'Cuando el proceso todavía cambia cada semana: automatizar algo inestable es congelar el desorden. Primero se define, después se automatiza. Tampoco vale la pena si ocurre dos veces al mes y toma cinco minutos: ahí el mantenimiento del flujo cuesta más que hacerlo a mano.' },
        ],
      },
      {
        type: 'steps',
