...
export const portfolio = [
  ...
  { t: 'Panama International Movers', cat: 'corporativo', catLabel: 'Web corporativa', tag: 'Mudanzas', year: '2025', img: '/portfolio/panamainternationalmovers-2026.jpg', href: 'https://panamainternationalmovers.com', desc: 'Sitio para una empresa familiar de mudanzas internacionales desde 1990, con más de 30 servicios (marítimo, aéreo, autos, mascotas, oficinas), mapa de destinos y cotización por WhatsApp.' },
  ...
  { t: 'Max Impresiones', cat: 'corporativo', catLabel: 'Web corporativa', tag: 'Imprenta', year: '2026', img: '/portfolio/maximpresiones.jpg', href: 'https://maximpresiones.com', desc: 'Sitio para una imprenta y centro de bordados en San Miguelito, con cotizador de ocho servicios (papelería, gigantografía, bordados, planos, sublimación) y pedidos enviados directo por WhatsApp.' },
